...
class SpaceTempGoG_detr_dota(nn.Module):
	...
	def extract_features(self, x, edge_index, img_feat, video_adj_list, edge_embeddings, temporal_adj_list, temporal_edge_w,
				batch_vec):
		"""
		Inputs:
		x - object-level graph nodes' feature matrix
		...
		return g_embed, img_feat, frame_embed_sg